...
{
    return m_laserEffect.type == EffectType::PeakingFilter || m_laserEffect.type == EffectType::HighPassFilter || m_laserEffect.type == EffectType::LowPassFilter || m_laserEffect.type == EffectType::PitchShift || m_laserEffect.type == EffectType::Bitcrush;
}
