...
private:
	...
	//TODO(skade) implement cleaner
	// faster scrolling with arrow keys
	bool m_isRepeat[4] = {false,false,false,false};
	const float m_repeatTimeStart = .2f;
	float m_repeatTimer[4] = {0.f,0.f,0.f,0.f};
