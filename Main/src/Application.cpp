...
void Application::WarnGauge()
{
    if (m_gaugeRemovedWarn)
    {
        g_gameWindow->ShowMessageBox("Gauge functions removed.",
            ...
            "Please update your skin or contact the skin author.",
            1);
...
static int lGetButton(lua_State* L /* int button */)
{
    ...
    if (g_application->autoplayInfo && (g_application->autoplayInfo->IsAutoplayButtons() || g_application->autoplayInfo->IsReplayingButtons()) && button < 6)
