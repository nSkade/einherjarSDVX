...
namespace Graphics
{
    ...
    bool FontRes::LoadFallbackFont()
    {
        ...
        return FT_New_Memory_Face(library, loadedFallbackFont.data(), (uint32)loadedFallbackFont.size(), 0, &fallbackFont) == 0 && FT_Select_Charmap(fallbackFont, FT_ENCODING_UNICODE) == 0;
    }
}
